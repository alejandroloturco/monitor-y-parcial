          ...
          while True:
            ...
            if menu == 1:
                ...
                for patient in sis.verInventario.keys():
                    if patient.verNombre() == name.lower() and patient.verCedula() == doc.lower():  
                            ...
                            if s_opcion==1:
                              for mar in inventario[patient]:
                                if isinstance (mar,Marcapasos):                           
                                  ...
                                  if op_m == 1:
                                      mar.asignarElectrodos(int(input("Ingrese la cantidad de electrodos: ")))       
                                  elif op_m == 2:
                                    mar.asignarConectividad(input("Ingrese la conectividad: "))
                                  elif op_m == 3:
                                    mar.asignarFrecuencia(int(input("Ingrese la frecuencia: ")))
                                  else:
                                    print("Ingrese una opcion valida")
                              ...
                              for i_d in inventario[patient]:
                                if isinstance(i_d,ImplanteDental):
                                  ...
                                  if op_id == 1:
                                    ...
                                    i_d.asignarFijacion_s(input("Ingrese el sistema de fijacion: "))
                                  elif op_id == 3:
